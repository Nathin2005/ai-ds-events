      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div>
            ...
            <p className="text-lg text-secondary-600">
              Manage faculty, student, and project achievements
            </p>
          </div>
        ...
        >
          ...
          <p className="text-secondary-600 mb-8 max-w-2xl mx-auto">
            Record and showcase outstanding achievements by faculty, students, and projects. 
            Track awards, recognitions, publications, patents, and competition results.
          </p>
          <div className="flex items-center justify-center space-x-4">
            <Link to="/admin/achievements/create" className="btn-primary flex items-center space-x-2">
              <FiPlus className="w-5 h-5" />
